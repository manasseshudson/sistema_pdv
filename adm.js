...
router.get('/adm/remUsusario/:uid_usuario/:id_usuario',(req,res)=>{
	const {uid_usuario, id_usuario}= req.params;
	
	knex('tb_usuario').where({id_usuario}).del().then(result=>{
		
		console.log(id_usuario);
		res.redirect('/adm/usuarios/'+uid_usuario);
	})
})
